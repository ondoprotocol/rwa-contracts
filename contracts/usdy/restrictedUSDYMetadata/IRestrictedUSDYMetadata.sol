...
interface IRestrictedUSDYMetadata {
  ...
  function addToRestrictedList(address account, Restriction calldata restriction) external;

  /// @notice Attempts to remove a restriction from the restricted list for the given account
  function removeFromRestrictedList(address account, Restriction calldata restriction) external;
