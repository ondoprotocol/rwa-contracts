...
import {IKYCRegistry} from "contracts/kyc/IKYCRegistry.sol";
import {IKYCRegistryClient} from "contracts/kyc/IKYCRegistryClient.sol";
import {
  Initializable
 ...
 *         of the KYC registry.
 */
abstract contract KYCRegistryClientUpgradeable is Initializable, IKYCRegistryClient {
   ...
   *      initialization
   */
  function __KYCRegistryClientInitializable_init(address _kycRegistry, uint256 _kycRequirementGroup)
    internal
    onlyInitializing
  {
    __KYCRegistryClientInitializable_init_unchained(_kycRegistry, _kycRequirementGroup);
  }
