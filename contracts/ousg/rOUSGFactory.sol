...
contract ROUSGFactory is IMulticall {
  ...
  function deployRebasingOUSG(
    ...
    rOUSGProxied.initialize(kycRegistry, requirementGroup, ousg, GUARDIAN, oracle);
    ...
    return (address(rOUSGProxy), address(rOUSGProxyAdmin), address(rOUSGImplementation));
  }
